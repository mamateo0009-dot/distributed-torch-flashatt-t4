...
async fn shutdown_signal() {
    ...
    tokio::select! {
        _ = ctrl_c => info!("[shutdown] Received Ctrl+C, draining connections..."),
        _ = terminate => info!("[shutdown] Received SIGTERM, draining connections..."),
    }
}
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let runtime = tokio::runtime::Builder::new_multi_thread()
        ...
        .thread_name("pearl-proxy-worker")
